...
echo "   - Try: ssh -i ~/.ssh/kidplay-arcade-key.pem ubuntu@3.81.165.163"
echo ""
...
echo "   - Or SCP if SSH is fixed: scp -i ~/.ssh/kidplay-arcade-key.pem /tmp/$PACKAGE_NAME.tar.gz ubuntu@3.81.165.163:~/"
echo ""
